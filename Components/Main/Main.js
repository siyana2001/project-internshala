...
import AllJobs from '../Allcity/Alljobs';
import Tcertificate from '../Tcertificate/Tcertificate';
...
export const Main = () => {
 ...
 <nav className="navbar navbar-expand-lg navbar-light">
    ...
    <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownInternships" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        Internships
    </a>
    <ul className="dropdown-menu" aria-labelledby="navbarDropdownInternships">
        ...
        <li><a className="dropdown-item" href="#">View all internships</a></li>
    </ul>
</li>
    ...
    <li className="dropdown-header">Certification Courses</li>
        <li><a className="dropdown-item" href="#">Web Development</a></li>
        <li><a className="dropdown-item" href="#">Programming with Python</a></li>
        <li><a className="dropdown-item" href="#">Data Science</a></li>
        <li><a className="dropdown-item" href="#">Digital Marketing</a></li>
        <li><a className="dropdown-item" href="#">Clinical Trial Analysis & Reporting</a></li>
        <li><a className="dropdown-item" href="#">Machine Learning</a></li>
        <li><a className="dropdown-item" href="#">Advanced Excel</a></li>
        <li><a className="dropdown-item" href="#">AutoCAD</a></li>
        <li><hr className="dropdown-divider" /></li>

        <li className="dropdown-header">Placement Guarantee Courses</li>
        ...
        <li><a className="dropdown-item" href="#">Electric Vehicle Course</a></li>
        <li><a className="dropdown-item" href="#">UI/UX Course</a></li>
...
<div>
  ...
  <h1 style={{textAlign:"center" , fontFamily:'cursive', marginTop:'4rem' }}>Internships / Jobs :</h1>
  <div className="container">
    <div className="row">
      <div className="col">
