...
export const Chennais = () => {
 ...
 <section id="c" style={{ display: 'flex', flexWrap: 'wrap', margin: '60px', gap: '50px', justifyContent: 'center' }}>
    ...
    <Link to={`/getchennais/${value.id}`} style={{ fontWeight: 'bold', fontStyle: 'italic', color: 'blue', textDecoration: 'none' }}>View more<span>&rarr;</span></Link>
</div>
        ...
        <Link to="/insert" className="btn btn-info btn-md" style={{ position: 'absolute', top: '30px', right: '20px', zIndex: '1000', marginTop: "40px", fontWeight: 'bold', textDecoration: 'none' }}>
                Insert
            </Link>
