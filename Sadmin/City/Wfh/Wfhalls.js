...
export const Wfhalls = () => {
    ...
    return (
        <>
                        ...
                        <Card style={{ height: '100%', width: '100%', position: 'relative' }}>
                            <Card.Body style={{ padding: '20px' }}>
                                ...
                                <div style={{ position: 'absolute', bottom: '10px', right: '15px' }}>
                                    <Link to={`/getwfhs/${value.id}`} style={{ fontWeight: 'bold', fontStyle: 'italic', color: 'blue', textDecoration: 'none' }}>View more<span>&rarr;</span></Link>
                                </div>
                            </Card.Body>
                        </Card>
                    </div>
            ...
            <Link to="/insertwfh" style={{ position: 'absolute', top: '30px', right: '20px', zIndex: '1000', marginTop: "40px", fontWeight: 'bold', textDecoration: 'none', color: 'blue' }}>
                Insert
            </Link>
        </>
    )
