...
export const Hydras = () => {
 ...
 <section id="c" style={{ display: 'flex', flexWrap: 'wrap', margin: '60px', gap: '50px', justifyContent: 'center' }}>
    ...
    <Link to={`/gethydras/${value.id}`} style={{ fontWeight: 'bold', fontStyle: 'italic', color: 'blue', textDecoration: 'none' }}>View more<span>&rarr;</span></Link>
</div>
        ...
        <Link to="/inserthydra" style={{ position: 'absolute', top: '30px', right: '20px', zIndex: '1000', marginTop: "40px", fontWeight: 'bold', textDecoration: 'none', color: 'blue' }}>
                Insert
            </Link>
  </>
  )
